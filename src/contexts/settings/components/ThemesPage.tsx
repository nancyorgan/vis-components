...
export const ThemesPage = () => {
	...
	return (
			...
			<div className="min-w-0">
				...
				<div className="flex flex-col gap-4">
					<CollapsibleSubsection
						title={<span className="text-sm">Global aesthetics</span>}
						boxed={false}
					>
						<fieldset
							disabled={isReadOnly}
					...
					<CollapsibleSubsection
						title={<span className="text-sm">Mark</span>}
						boxed={false}
					>
						<fieldset
							disabled={isReadOnly}
		...
		{/* Mark defaults */}
					...
					<CollapsibleSubsection
						title={<span className="text-sm">Axes and gridlines</span>}
						boxed={false}
					>
						<fieldset
							disabled={isReadOnly}
					...
					<CollapsibleSubsection
						title={<span className="text-sm">Legend</span>}
						boxed={false}
					>
						<fieldset
							disabled={isReadOnly}
					...
					<CollapsibleSubsection
						title={<span className="text-sm">Text</span>}
						boxed={false}
					>
						<fieldset
							disabled={isReadOnly}
					...
					<CollapsibleSubsection
						title={<span className="text-sm">Color palettes</span>}
						boxed={false}
					>
						<fieldset
							disabled={isReadOnly}
					...
					<CollapsibleSubsection
						title={<span className="text-sm">Gradients</span>}
						boxed={false}
					>
						<fieldset
							disabled={isReadOnly}
					...
					<CollapsibleSubsection
						title={<span className="text-sm">Patterns</span>}
						boxed={false}
					>
						<fieldset
							disabled={isReadOnly}
					...
					<CollapsibleSubsection
						title={<span className="text-sm">Distribution and regression</span>}
						boxed={false}
					>
						<fieldset
							disabled={isReadOnly}
					...
					<CollapsibleSubsection
						title={<span className="text-sm">Aesthetic ranges</span>}
						boxed={false}
					>
						<fieldset
							disabled={isReadOnly}
